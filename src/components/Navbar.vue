<template>
  <div class="sticky top-0 z-40">
      ...
      <!-- dropdown menu -->
      <div @click.stop class="absolute bg-gray-100 border border-t-0 shadow-xl text-gray-700 rounded-b-lg w-48 bottom-10 right-0 mr-6" :class="dropDownOpen ? '' : 'hidden'">
          <a href="#" class="block px-4 py-2 hover:bg-gray-200">Account</a>
          <a href="#" class="block px-4 py-2 hover:bg-gray-200">Preferences</a>
          <a href="#" class="block px-4 py-2 hover:bg-gray-200">Logout</a>
      </div>
      <!-- dropdown menu end -->

      <!-- Sidebar -->
      <div v-if="sideBarOpen" @click.stop>
